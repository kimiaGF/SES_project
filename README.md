...
2. **Add Offset Points**:
   - Creates new points offset from the labeled points based on PCA and outward vectors. Offsets can be iteratively generated by reading output files as new inputs via command line arguments.
3. **Visualization**:
